...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://e-learningbackend-s24h.onrender.com/api/auth/register", {
        method: "POST",
        headers: {
  ...
  <label htmlFor="role" className="block text-sm font-medium text-gray-300"> {/* Improved label styling */}
    Role
  </label>
  <select
    id="role"
